-- Publication sanitization: personnel, account markers and assignments are fictional.
-- Original DDL and nonsensitive lookup data are retained. Credential markers are not real secrets.
-- phpMyAdmin SQL Dump
-- version 4.0.10deb1
...
(1, 'Faculty-1', 'Fictional', 'Assistant Professor I', 'Mrs', 'CIT', 5, '', 'demo_faculty_1', 'FICTIONAL-CREDENTIAL-1', 'admin'),
(2, 'Faculty-2', 'Fictional', 'Assistant Professor I', 'Dr', 'CAS', 66, '', 'demo_faculty_2', 'FICTIONAL-CREDENTIAL-2', 'admin');
...
(1, 4, 'm', 1, 'ENG1', 'BSED 1A', '101', 'Fictional demonstration assignment', 12, 'demo_admin'),
(2, 5, 'w', 2, 'ALG', 'BEED 1A', '102', 'Fictional demonstration assignment', 12, 'demo_admin'),
(3, 6, 'f', 1, 'COMPLIT', 'BEED 1B', '103', 'Fictional demonstration assignment', 12, 'demo_admin'),
(4, 7, 't', 2, 'SOCSCI', 'BSED 1A', '101', 'Fictional demonstration assignment', 12, 'demo_admin'),
(5, 8, 'th', 1, 'ENG1', 'BEED 1A', '102', 'Fictional demonstration assignment', 12, 'demo_admin'),
(6, 9, 's', 2, 'ALG', 'BEED 1B', '103', 'Fictional demonstration assignment', 12, 'demo_admin'),
(7, 10, 'u', 1, 'COMPLIT', 'BSED 1A', '101', 'Fictional demonstration assignment', 12, 'demo_admin'),
(8, 11, 'm', 2, 'SOCSCI', 'BEED 1A', '102', 'Fictional demonstration assignment', 12, 'demo_admin');
...
(1, 'ENG1', 'English 1', 1),
(2, 'ALG', 'Algebra', 2),
(3, 'COMPLIT', 'Computer Literacy', 1),
(4, 'SOCSCI', 'Social Science', 2);
...
(1, 'demo_admin', 'FICTIONAL-CREDENTIAL-ADMIN', 'Fictional Demo Administrator', 'active', 'all');
